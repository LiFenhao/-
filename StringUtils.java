...
public abstract class StringUtils {
	...
	public static boolean isEmpty(  Object str) {
		return (str == null || str.equals(null) || "".equals(str.toString().trim()));
	}
	
	
	public static Object getNullValue(Object str) {
	...
	public static Object getInsertValue(Object str) {
		 if(str == null || "".equals(str.toString().trim())) {
			 return null;
		 }
		return "'"+str+"'";
	...
	public static boolean isPosIntegerWithZero(String str) {
		if(isInteger(str)) {
			return Long.valueOf(str) >= 0; 
		}else {
			return false;
